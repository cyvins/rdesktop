...
RD_BOOL g_disable_win_key = False;
...
usage(char *program)
{
	...
	fprintf(stderr, "   -W: disable win key for client\n");
...
#define VNCOPT
	...
	while ((c = getopt(argc, argv,
			   VNCOPT "A:u:L:d:s:c:p:n:k:g:o:fbBeEitmzCDKWS:T:NX:a:x:Pr:045vh?")) != -1)
	{
		switch (c)
		{
#ifdef RDP2VNC
